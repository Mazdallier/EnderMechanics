 ...
 * being clicked on with a shift-click or shift-right-click, depending on the config.
 * @author endreman0
 */
public interface IWrench{
	 ...
	 * {@linkplain com.endreman0.endermechanics.api.IWrenchBreakable#getTier() tier} is less than
	 * or equal to the tier returned by this wrench.
	 * The primary use for this method would be to decrement power.
	 * NOTE: IF THE METHOD RETURNS FALSE,
	 * {@link #onInvalidUse(EntityPlayer, int, int, int) onInvalidUse()} WILL BE CALLED.
	 ...
	 * {@linkplain com.endreman0.endermechanics.api.IWrenchBreakable#getTier() tier} is greater
	 * than this wrench's, or {@link #onValidUse(EntityPlayer, int, int, int) onValidUse()}
	 ...
	 * {@linkplain com.endreman0.endermechanics.api.IWrenchBreakable#getTier() tier} of the block
	 * being clicked.
