...
import com.endreman0.endermechanics.tile.TileFurnace;
...
public class BlockFurnace extends BlockMachine{
	public BlockFurnace(){super(null, "furnace");}
	@Override public TileEntity createNewTileEntity(World world, int meta){return new TileFurnace();}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int meta, float partialX, float partialY, float partialZ){
		...
		player.openGui(EnderMechanics.instance, 4, world, x, y, z);
		return true;
	}
}
